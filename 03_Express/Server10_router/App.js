...
// app.get('/', (req, res)=>{ res.send("<h1>Router 학습</h1>") });
// 외부에 생성되고 클라이언트 요청에 응답할 수 있는 router들을 갖고 있는 파일을 require합니다. 
const indexRouter = require('./Routers');
// 어느 폴더이든 그 안의 index.js는 파일이름을 쓰지 않아도 index.js가 require 되는 걸로 인식됩니다. 

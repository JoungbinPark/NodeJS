...
//path.js는 외부모듈이어서 별도의 설치과정이 예전에 필요했으나, 자바스크립트와 node.js의 버전업에 따라 지금은 별도 설치 과정없이 require가 가능해졌습니다.

// path가 아니어도 사용가능한 경로와 파일관련 상수
